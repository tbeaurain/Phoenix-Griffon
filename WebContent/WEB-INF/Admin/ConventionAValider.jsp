...
<html lang="fr">
	...
	<head>
	    ...
	    <title>JobISEP - Conventions à valider</title>
	    ...
	    <div id="wrapper">
	        ...
	        <div id="page-wrapper">
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="col-lg-12">
	                        <h1 class="page-header">Affichage des conventions à valider</h1>
	                    </div>
	                    <!-- /.col-lg-12 -->
	                </div>
	            </div>
	            	...
	            	System.out.println("ok");
		               	...
		               	if(liste.size()!=0){
			     	      	for(Utilisateur utilisateur : liste){
			     	      		out.print("<div class=\"col-md-1\"></div><div class=\"col-md-8\"><div class=\"panel panel-info\"><div class=\"panel-heading\"><h4> Convention de " + utilisateur.getPrenom() + " " + utilisateur.getNom() + " </h4></div><div class=\"panel-body\"><div class=\"row\"><div class=\"col-lg-12\"> <a href=\"AfficherConvention?ideleve=" + utilisateur.getId() +"\">Voir la convention</a>" +  "</div></div></div></div></div><hr style=\"clear:both;\">");
