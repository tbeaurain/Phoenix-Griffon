        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <h1 class="page-header">Convention de stage de ${eleve.prenom} ${eleve.nom}</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-1">
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-primary">
                        	<div class="panel-heading">
                                Informations contenues dans la convention de stage
                            </div>
                            	...
                            	<c:if test="${erreur==false}" var="maVariable" scope="session">
                            		<c:if test="${stage_valide_flag==true}" var="maVariable" scope="session">
	                               		<div class="alert alert-success">
	                               			Cette convention a bien été validée.
	                            		</div>
                            		</c:if>
                            		<c:if test="${stage_valide_flag==false}" var="maVariable" scope="session">
	                               		<div class="alert alert-danger">
	                               			Cette convention de stage est en attente de validation.
	                            		</div>
                            		</c:if>
                            		<c:if test="${stage_valide_flag==false}" var="maVariable" scope="session">
