...
/**
 * Servlet implementation class RechercheConvention
 */
@WebServlet(name="/RechercheConvention", urlPatterns={"/RechercheConvention"})
public class RechercheConvention extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	public static final String VUE_SUCCES = "/WEB-INF/Admin/AfficherConventionParEleve.jsp";
