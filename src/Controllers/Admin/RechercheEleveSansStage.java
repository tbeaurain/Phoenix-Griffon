...
/**
 * Servlet implementation class RechercheEleveSansStage
 */
@WebServlet(name="/RechercheEleveSansStage", urlPatterns={"/RechercheEleveSansStage"})
public class RechercheEleveSansStage extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	public static final String VUE_SUCCES = "/WEB-INF/Admin/ElevesSansStage.jsp";
     ...
     */
    public RechercheEleveSansStage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (int i = 1; i<6; i++){
			if (bddUtilisateur.find(i).getNom() != null){
				...
				ArrayList<EffectueStage> stagesListe = new ArrayList<>(u.getEffectueStages());
				if(stagesListe.size()==0){
